...
export const prologueNodes: DialogueNode[] = [
  ...
  },
  {
    id: 'prologue-3',
    speaker: 'narrator',
    text: '窗外的城市還亮著零星的燈，像是這個世界**最後幾顆沒睡的眼睛**。',
    nextNodeId: 'prologue-4',
  },
  {
    id: 'prologue-4',
    speaker: 'narrator',
    text: '她已經在這個位置坐了六個小時。不，如果把白天也算進去，應該是**十四個小時**。',
    nextNodeId: 'prologue-5',
  },
  {
    id: 'prologue-5',
    speaker: 'narrator',
    text: '她想起主管的臉。那張臉在會議室裡看著她，眉頭皺成一個**嫌棄的弧度**。',
  ...
  },
  {
    id: 'prologue-8',
    speaker: 'narrator',
    text: '她的手移向滑鼠。不是要繼續改報告。她打開了**另一個資料夾**。',
    nextNodeId: 'prologue-9',
  },
  {
    id: 'prologue-9',
    speaker: 'narrator',
    text: '那個資料夾藏在電腦最深的角落，標題是一串**亂碼**。但她知道裡面是什麼。',
  ...
  },
  {
    id: 'prologue-10',
    speaker: 'narrator',
    text: '那是她的**祕密**。是她下班後、週末時、失眠夜裡偷偷寫的東西——',
  ...
  },
  {
    id: 'prologue-12',
    speaker: 'narrator',
    text: '她寫了**三年**。斷斷續續，寫了將近**十萬字**。沒有人知道。',
    nextNodeId: 'prologue-13',
  },
  {
    id: 'prologue-13',
    speaker: 'narrator',
    text: '她打開那個資料夾。十二個檔案，整齊地排列著。每一個檔案都是**一塊她不敢讓人看見的心**。',
  ...
  // 刪除路線
  {
    ...
    speaker: 'narrator',
    text: '她按下了「**確定**」。檔案消失了。像是**從來沒有存在過**一樣。',
  ...
  },
  {
    ...
    speaker: 'narrator',
    text: '那些文字，那些故事，那些深夜裡的自己——它們**真的該被刪除**嗎？',
    nextNodeId: 'prologue-merge-1',
    effect: 'glow',
  },
  // 合流
  ...
  },
  {
    id: 'prologue-merge-2',
    speaker: 'narrator',
    text: '不是普通的閃爍。是那種......像是有什麼東西想要**衝破螢幕**的閃爍。',
  ...
  },
  {
    id: 'prologue-merge-8',
    speaker: 'narrator',
    text: '她感覺自己的意識被拉進了一個**無盡的深淵**。光消失了。聲音消失了。',
