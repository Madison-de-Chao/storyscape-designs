...
export const chapter6Nodes: DialogueNode[] = [
  ...
  // 二、見到王陽明
  {
    id: 'yi1-ch6-5',
    speaker: 'narrator',
    text: '洞裡比她想像的寬敞。地上鋪著乾草，角落有一張簡陋的木桌，桌上放著幾卷書和一盞油燈。一個人坐在桌前——她認得那個背影。',
  ...
  },
  {
    ...
    speakerName: '王陽明',
    text: '妳來了。我記得妳——那個在庭院裡問「我到底做錯了什麼」的孩子。',
    effect: 'glow',
    nextNodeId: 'yi1-ch6-6a',
  },
  {
    id: 'yi1-ch6-6a',
    speaker: 'protagonist',
    text: '先生……您記得我？',
    nextNodeId: 'yi1-ch6-6b',
  },
  {
    id: 'yi1-ch6-6b',
    speaker: 'wangyangming',
    speakerName: '王陽明',
    text: '當然。那時我告訴妳「心即理」，但妳還沒準備好接受。',
    nextNodeId: 'yi1-ch6-6c',
  },
  {
    id: 'yi1-ch6-6c',
    speaker: 'wangyangming',
    speakerName: '王陽明',
    text: '妳問過我：「大家都說我不夠好，我該怎麼辦？」我反問妳：「大家是誰？」',
    nextNodeId: 'yi1-ch6-6d',
  },
  {
    id: 'yi1-ch6-6d',
    speaker: 'protagonist',
    text: '我記得……我說不出具體的名字。',
    nextNodeId: 'yi1-ch6-6e',
  },
  {
    id: 'yi1-ch6-6e',
    speaker: 'wangyangming',
    speakerName: '王陽明',
    text: '對。因為那只是一種「感覺」，而非事實。現在，妳走過了蘇軾的風雨，看見了東坡的曠達——',
    nextNodeId: 'yi1-ch6-6f',
  },
  {
    id: 'yi1-ch6-6f',
    speaker: 'wangyangming',
    speakerName: '王陽明',
    text: '這一次，我要帶妳去更深的地方。不是向外看，而是**向內看**。',
    effect: 'glow',
