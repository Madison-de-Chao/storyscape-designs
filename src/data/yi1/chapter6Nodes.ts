...
export const chapter6Nodes: DialogueNode[] = [
  ...
  },
  {
    ...
    nextNodeId: 'yi1-chapter-6-11',
  },
  {
    id: 'yi1-chapter-6-11',
    speaker: 'wangyangming',
    text: '你一直在問自己——我到底哪裡做錯了？為什麼我這麼努力，還是不夠好？',
    nextNodeId: 'yi1-chapter-6-12',
  },
  {
    id: 'yi1-chapter-6-12',
    speaker: 'wangyangming',
    text: '你問過很多人。父母說你不夠聽話，老師說你不夠聰明，朋友說你想太多，主管說你不夠專業。每個人都有答案，但每個人的答案都不一樣。',
    nextNodeId: 'yi1-chapter-6-13',
  },
  {
    id: 'yi1-chapter-6-13',
    speaker: 'wangyangming',
    text: '所以你越問越迷惑，越問越不知道自己是誰。',
    nextNodeId: 'yi1-chapter-6-14',
  },
  {
    id: 'yi1-chapter-6-14',
    speaker: 'narrator',
    text: '她的眼淚掉了下來。',
    nextNodeId: 'yi1-chapter-6-15',
  },
  ...
  // 四、向外求的困境
  {
    ...
    nextNodeId: 'yi1-chapter-6-22',
  },
  {
    id: 'yi1-chapter-6-22',
    speaker: 'protagonist',
    text: '答案？什麼答案？',
    nextNodeId: 'yi1-chapter-6-23',
  },
  {
    id: 'yi1-chapter-6-23',
    speaker: 'wangyangming',
    text: '聖人之道。我想知道，怎樣才能成為一個聖人？怎樣才能做一個「對」的人？',
    nextNodeId: 'yi1-chapter-6-24',
  },
  {
    id: 'yi1-chapter-6-24',
    speaker: 'wangyangming',
    text: '我按照朱熹的方法，「格物致知」——觀察事物，從中悟出道理。我對著竹子看了七天七夜，想要「格」出竹子的道理。',
    nextNodeId: 'yi1-chapter-6-25',
  },
  {
    id: 'yi1-chapter-6-25',
    speaker: 'protagonist',
    text: '結果呢？',
    nextNodeId: 'yi1-chapter-6-26',
  },
  {
    id: 'yi1-chapter-6-26',
    speaker: 'wangyangming',
    text: '結果我病倒了。竹子還是竹子，我什麼都沒悟出來。',
    nextNodeId: 'yi1-chapter-6-27',
  },
  {
    id: 'yi1-chapter-6-27',
    speaker: 'wangyangming',
    text: '我跑遍天下拜訪名師。有人說道在經典裡，有人說道在天地間，有人說道在聖人的言行裡。我試了所有的方法，但我還是沒有找到。',
    nextNodeId: 'yi1-chapter-6-28',
  },
  {
    id: 'yi1-chapter-6-28',
    speaker: 'wangyangming',
    ...
    choices: [
      {
        ...
        nextNodeId: 'yi1-chapter-6-resonate-1',
        arcChange: 3,
        shadowChange: 0,
      },
      {
        ...
        text: '那答案在哪裡？',
        nextNodeId: 'yi1-chapter-6-question-1',
        arcChange: 0,
        shadowChange: 0,
      },
    ],
  ...
  // 共鳴路線
  {
    id: 'yi1-chapter-6-resonate-1',
    speaker: 'protagonist',
    text: '我也是這樣……我讀了那麼多書，學了那麼多方法，照著做了，但我還是不快樂。還是覺得自己不夠好。',
    nextNodeId: 'yi1-chapter-6-merge-1',
  },

  // 提問路線
  {
    id: 'yi1-chapter-6-question-1',
    speaker: 'protagonist',
    text: '如果不在外面……那答案在哪裡？',
    nextNodeId: 'yi1-chapter-6-merge-1',
  },
  ...
  // 合併：龍場悟道
  {
    id: 'yi1-chapter-6-merge-1',
    speaker: 'wangyangming',
    text: '問題出在——你一直在問別人「我該怎麼做」，但你從來沒有問過自己「我想要什麼」。',
    nextNodeId: 'yi1-chapter-6-merge-2',
  },
  {
    id: 'yi1-chapter-6-merge-2',
    speaker: 'wangyangming',
    text: '就在這個山洞裡，有一天半夜，我突然從夢中醒來。我有一種很強烈的感覺——我找錯方向了。',
    nextNodeId: 'yi1-chapter-6-merge-3',
  },
  {
    id: 'yi1-chapter-6-merge-3',
    speaker: 'wangyangming',
    text: '我一直在外面找答案，但答案不在外面。',
    nextNodeId: 'yi1-chapter-6-merge-4',
  },
  {
    id: 'yi1-chapter-6-merge-4',
    speaker: 'wangyangming',
    text: '**聖人之道，吾性自足。**',
    effect: 'glow',
    nextNodeId: 'yi1-chapter-6-merge-5',
  },
  {
    id: 'yi1-chapter-6-merge-5',
    speaker: 'protagonist',
    text: '什麼意思？',
    nextNodeId: 'yi1-chapter-6-merge-6',
  },
  {
    id: 'yi1-chapter-6-merge-6',
    speaker: 'wangyangming',
    text: '意思是——成為聖人的道理，本來就在我的心裡。我不需要去外面找，我只需要——向內看。',
    nextNodeId: 'yi1-chapter-6-merge-7',
  },

  // 五、向內看
  {
    id: 'yi1-chapter-6-merge-7',
    speaker: 'protagonist',
    text: '什麼叫「向內看」？',
    nextNodeId: 'yi1-chapter-6-merge-8',
  },
  {
    id: 'yi1-chapter-6-merge-8',
    speaker: 'wangyangming',
    text: '你讀書的時候，是不是覺得——這本書說得對，我要照著做？然後你照著做了，發現不對。於是你又去讀另一本書……',
    nextNodeId: 'yi1-chapter-6-merge-9',
  },
  {
    id: 'yi1-chapter-6-merge-9',
    speaker: 'wangyangming',
    text: '你讀了越來越多的書，試了越來越多的方法，但你還是覺得自己做什麼都不對。',
    nextNodeId: 'yi1-chapter-6-merge-10',
  },
  {
    id: 'yi1-chapter-6-merge-10',
    speaker: 'wangyangming',
    text: '閉上眼睛。',
    nextNodeId: 'yi1-chapter-6-merge-11',
  },
  {
    id: 'yi1-chapter-6-merge-11',
    speaker: 'narrator',
    text: '她猶豫了一下，然後閉上眼睛。山洞裡很安靜，她能聽見風穿過松林的聲音，能聽見自己的心跳。',
    nextNodeId: 'yi1-chapter-6-merge-12',
  },
  {
    id: 'yi1-chapter-6-merge-12',
    speaker: 'wangyangming',
    text: '現在，問你自己一個問題——你為什麼要寫那些故事？',
    nextNodeId: 'yi1-chapter-6-merge-13',
  },
  {
    id: 'yi1-chapter-6-merge-13',
    speaker: 'narrator',
    ...
    choices: [
      {
        ...
        nextNodeId: 'yi1-chapter-6-myself-1',
        arcChange: 5,
        shadowChange: 0,
      },
      {
        ...
        text: '也許只是逃避現實……',
        nextNodeId: 'yi1-chapter-6-escape-1',
        arcChange: 0,
        shadowChange: 2,
      },
    ],
  ...
  // 做自己路線
  {
    id: 'yi1-chapter-6-myself-1',
    speaker: 'narrator',
    text: '她的腦海裡浮現出那些深夜——下班後坐在電腦前，疲憊不堪但不想睡。打開隱藏的資料夾，開始寫。',
    nextNodeId: 'yi1-chapter-6-myself-2',
  },
  {
    id: 'yi1-chapter-6-myself-2',
    speaker: 'narrator',
    text: '寫著寫著，她忘記了時間，忘記了那些讓她難過的事。她覺得自己——活著。',
    nextNodeId: 'yi1-chapter-6-myself-3',
  },
  {
    id: 'yi1-chapter-6-myself-3',
    speaker: 'protagonist',
    text: '因為……寫的時候，我覺得我是我自己。',
    nextNodeId: 'yi1-chapter-6-end-1',
  },

  // 逃避路線
  {
    id: 'yi1-chapter-6-escape-1',
    speaker: 'protagonist',
    text: '也許只是逃避現實……不想面對那些煩心事。',
    nextNodeId: 'yi1-chapter-6-escape-2',
  },
  {
    id: 'yi1-chapter-6-escape-2',
    speaker: 'wangyangming',
  ...
  // 結尾：良知
  {
    id: 'yi1-chapter-6-end-1',
    speaker: 'wangyangming',
    text: '「**我是我自己**」——這就是答案。',
    effect: 'glow',
    nextNodeId: 'yi1-chapter-6-end-2',
  },
  {
    id: 'yi1-chapter-6-end-2',
    speaker: 'wangyangming',
    text: '你寫故事的時候，不是為了別人，是為了你自己。那個時候，你不需要別人的認可，你只是在做你想做的事。那個時候，你是完整的。',
    nextNodeId: 'yi1-chapter-6-end-3',
  },
  {
    id: 'yi1-chapter-6-end-3',
    speaker: 'wangyangming',
    text: '你知道為什麼平時覺得「做什麼都不對」嗎？因為你一直在用別人的標準來評價自己。你把「對錯」的權力，交給了別人。',
    nextNodeId: 'yi1-chapter-6-end-4',
  },
  {
    id: 'yi1-chapter-6-end-4',
    speaker: 'wangyangming',
    text: '但寫故事的時候不一樣。沒有人告訴你「這樣才對」，沒有人評價你「好不好」。你只是在寫，在創造，在表達你自己。那個時候，「對錯」的權力在你手裡。',
    nextNodeId: 'yi1-chapter-6-end-5',
  },
  {
    id: 'yi1-chapter-6-end-5',
    speaker: 'wangyangming',
    text: '這就是「**吾性自足**」的意思——你不需要去外面找答案，因為答案本來就在你心裡。你不需要別人告訴你「對不對」，因為你自己知道什麼是對的。',
    effect: 'glow',
    nextNodeId: 'yi1-chapter-6-end-6',
  },
  {
    id: 'yi1-chapter-6-end-6',
    speaker: 'protagonist',
    text: '可是……如果我不聽別人的，那我怎麼知道自己是不是錯了？',
    nextNodeId: 'yi1-chapter-6-end-7',
  },
  {
    id: 'yi1-chapter-6-end-7',
    speaker: 'wangyangming',
    text: '你寫故事的時候，怎麼知道這一段寫得好不好？',
    nextNodeId: 'yi1-chapter-6-end-8',
  },
  {
    id: 'yi1-chapter-6-end-8',
    speaker: 'protagonist',
    text: '我……就是知道。有時候寫完會覺得「對，就是這個感覺」，有時候會覺得「不對，要改」。沒有人告訴我，我自己就是知道。',
    nextNodeId: 'yi1-chapter-6-end-9',
  },
  {
    id: 'yi1-chapter-6-end-9',
    speaker: 'wangyangming',
    text: '這就是你的「**良知**」。每個人心裡都有一個聲音，能夠分辨是非對錯。這個聲音不是學來的，是天生的。',
    effect: 'glow',
    nextNodeId: 'yi1-chapter-6-end-10',
  },
  {
    id: 'yi1-chapter-6-end-10',
    speaker: 'wangyangming',
    text: '問題是——在日常生活中，你把這個聲音忽略了。你不再相信自己的判斷，只相信別人的判斷。你不再聽自己的聲音，只聽別人的聲音。',
    nextNodeId: 'yi1-chapter-6-end-11',
  },
  {
    id: 'yi1-chapter-6-end-11',
    speaker: 'wangyangming',
    text: '所以你才會覺得「做什麼都不對」——因為你用別人的「對」來要求自己，而忘記了你自己的「對」。',
    nextNodeId: 'yi1-chapter-6-end-12',
  },
  {
    id: 'yi1-chapter-6-end-12',
    speaker: 'narrator',
    text: '她聽著，心裡有什麼東西在鬆動。',
    nextNodeId: 'yi1-chapter-6-end-13',
  },
  {
    id: 'yi1-chapter-6-end-13',
    speaker: 'wenxin',
    text: '時候到了。下一位歸者在等你。',
    nextNodeId: 'yi1-chapter-6-end-14',
  },
  {
    id: 'yi1-chapter-6-end-14',
    speaker: 'wangyangming',
