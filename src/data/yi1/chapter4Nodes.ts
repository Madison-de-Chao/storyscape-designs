...
export const chapter4Nodes: DialogueNode[] = [
  // 開場引言
  {
    id: 'chapter-4-intro-1',
    speaker: 'narrator',
    text: '「每一個靈魂都有一棵樹。」',
    nextNodeId: 'chapter-4-intro-2',
  },
  {
    id: 'chapter-4-intro-2',
    speaker: 'narrator',
    text: '「那棵樹記錄著你所有的選擇——包括那些你不願意承認的。」',
    nextNodeId: 'chapter-4-1',
  },
  ...
  // 一、蘇軾的故事
  {
    ...
    nextNodeId: 'chapter-4-2',
  },
  {
    id: 'chapter-4-2',
    speaker: 'narrator',
    text: '不是書本上的歷史敘述，而是他親口說的、帶著溫度的人生經歷。',
    nextNodeId: 'chapter-4-3',
  },
  {
    id: 'chapter-4-3',
    speaker: 'narrator',
    text: '他說起烏臺詩案，說起被關在牢裡的一百多天。說起黃州、惠州、儋州——一貶再貶。',
    nextNodeId: 'chapter-4-4',
  },
  {
    id: 'chapter-4-4',
    speaker: 'sushi',
    text: '貶到最後，我都不知道還有哪裡可以貶了。',
    nextNodeId: 'chapter-4-5',
  },
  {
    id: 'chapter-4-5',
    speaker: 'protagonist',
    text: '你不生氣嗎？',
    nextNodeId: 'chapter-4-6',
  },
  {
    id: 'chapter-4-6',
    speaker: 'sushi',
    text: '一開始當然生氣。我覺得自己沒有做錯什麼，為什麼要受這種罪？',
    nextNodeId: 'chapter-4-7',
  },
  {
    id: 'chapter-4-7',
    speaker: 'sushi',
    text: '後來我發現，生氣沒有用。我生氣，他們不會受傷。我生氣，唯一受傷的人——是我自己。',
    nextNodeId: 'chapter-4-8',
  },
  {
    id: 'chapter-4-8',
    speaker: 'protagonist',
    text: '那你怎麼做到不生氣的？',
    nextNodeId: 'chapter-4-9',
  },
  {
    id: 'chapter-4-9',
    speaker: 'sushi',
  ...
  // 二、命樹介紹
  {
    ...
    speaker: 'narrator',
    text: '蘇軾站起身，走到那棵老樹下。',
    nextNodeId: 'chapter-4-12',
  },
  {
    id: 'chapter-4-12',
    speaker: 'sushi',
    text: '你知道這是什麼樹嗎？這是我的命樹。在元壹境，每一個靈魂都有一棵命樹。',
    nextNodeId: 'chapter-4-13',
  },
  {
    id: 'chapter-4-13',
    speaker: 'sushi',
    text: '記錄你一生所有選擇的樹。每一個選擇都會在樹上留下痕跡。好的選擇，會讓樹長得更茂盛。壞的選擇……',
    nextNodeId: 'chapter-4-14',
  },
  {
    id: 'chapter-4-14',
    speaker: 'protagonist',
    text: '會讓樹枯萎？',
    nextNodeId: 'chapter-4-15',
  },
  {
    id: 'chapter-4-15',
    speaker: 'sushi',
  ...
  // 直面路線
  {
    ...
    speaker: 'protagonist',
    text: '伊在裡面，對不對？',
    nextNodeId: 'chapter-4-46',
  },
  {
    id: 'chapter-4-46',
    speaker: 'wenxin',
    text: '是的。那些你切割掉的部分，都在那裡。它們聚集在一起，形成了伊。',
    nextNodeId: 'chapter-4-merge-1',
  },

  // 逃避路線
  {
    id: 'chapter-4-avoid-1',
    speaker: 'protagonist',
    text: '我不想知道……那個洞太可怕了……',
    nextNodeId: 'chapter-4-avoid-2',
  },
  {
    id: 'chapter-4-avoid-2',
    speaker: 'wenxin',
  ...
  // 合併路線
  {
    id: 'chapter-4-merge-1',
    speaker: 'protagonist',
    text: '我現在要進去嗎？',
    nextNodeId: 'chapter-4-merge-2',
  },
  {
    id: 'chapter-4-merge-2',
    speaker: 'wenxin',
    text: '不。你還沒準備好。',
    nextNodeId: 'chapter-4-merge-3',
  },
  {
    id: 'chapter-4-merge-3',
    speaker: 'protagonist',
    text: '怎樣才算準備好？',
    nextNodeId: 'chapter-4-merge-4',
  },
  {
    id: 'chapter-4-merge-4',
    speaker: 'wenxin',
    text: '當你不再害怕的時候。當你願意擁抱而不是消滅的時候。',
    effect: 'glow',
    nextNodeId: 'chapter-4-merge-5',
  },
  {
    id: 'chapter-4-merge-5',
    speaker: 'protagonist',
    text: '我需要做什麼？',
    nextNodeId: 'chapter-4-merge-6',
  },
  {
    id: 'chapter-4-merge-6',
    speaker: 'wenxin',
    text: '繼續見歸者，聽他們的故事。每一個歸者，都會教你一件事。當你學會了足夠多的事，你就準備好了。',
    nextNodeId: 'chapter-4-merge-7',
  },
  {
    id: 'chapter-4-merge-7',
    speaker: 'wenxin',
    text: '然後你回到這裡，走進去，見伊。你可以繼續和她對抗——那樣你會永遠停留在這裡。',
    nextNodeId: 'chapter-4-merge-8',
  },
  {
    id: 'chapter-4-merge-8',
    speaker: 'wenxin',
    text: '或者你可以擁抱她，讓她回到你體內。讓那些被切割的部分，重新成為你的一部分。',
    nextNodeId: 'chapter-4-choice-2',
  },
  ...
  // 承諾路線
  {
    ...
    nextNodeId: 'chapter-4-end-2',
  },
  {
    id: 'chapter-4-end-2',
    speaker: 'narrator',
    text: '樹沒有回應。但她覺得，有什麼東西在樹根深處動了一下。像是有人聽見了。像是有人在等待。',
    nextNodeId: 'chapter-4-end-final',
  },

  // 懷疑路線
  {
    id: 'chapter-4-doubt-1',
    speaker: 'protagonist',
    text: '我不確定……看到這棵樹的樣子，我不確定我能做到……',
    nextNodeId: 'chapter-4-doubt-2',
  },
  {
    id: 'chapter-4-doubt-2',
    speaker: 'wenxin',
  ...
  // 結尾
  {
    id: 'chapter-4-end-final',
    speaker: 'wenxin',
    text: '走吧。下一位歸者在等你。一個在絕境中找到答案的人——吾性自足，不假外求。',
    nextNodeId: 'chapter-5-intro-1',
  },
];
